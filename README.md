...
如果你要在这个仓库里新增、修改或下线插件，请先阅读：

- [双栈插件开发工作流](./dev_workflow.md)
...
Teacher Tui产品经理大师 - 专业的产品经理工具集，以 Teacher Tui 式犀利风格提供产品管理全流程支持，并已做 Claude / Codex 基础双栈兼容。
...
- 🧩 双栈兼容：主要 `skills/` 可同时给 Claude Code 和 Codex 使用，个别平台相关技能会单独标注
...
| 命令 | 说明 |
|------|------|
| `/tmux-init` | 初始化向导，检测 tmux、安装配置、展示使用指南 |
| `/tmux-layout` | 手动建立或复用三栏协作布局 |

[查看详细文档](./plugins/tmux-coop/README.md)
